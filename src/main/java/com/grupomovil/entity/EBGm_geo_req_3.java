...
/**
 *
 * @author Jonathan.Enciso
 */
public class EBGm_geo_req_3 {
    ...
    // Entradas
    private String entrada;         //Vehicle (Entrada)

    
    /**
     * @return the vehicle in
     */
    public String get_vehicle_in() {
        return entrada;
    }
     ...
     * @param entrada
     */
    public void set_vehicle_in(String entrada) {
