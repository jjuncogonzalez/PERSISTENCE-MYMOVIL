...
/**
 * Entidad que permite manejar la alarma del desgaste de las pastillas de frenos
 * @author Omar.beltran
 */
public class EBBrakePadWear {
   public class LocalizacionVehiculo {
    ...
    public int getEstadoDesgasteFrenos() {
        return estadoDesgasteFrenos;
    }

    public void setEstadoDesgasteFrenos(int estadoDesgasteFrenos) {
