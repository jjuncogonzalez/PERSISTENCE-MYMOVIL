...
/**
 * Entidad que permite relacionar la alarma de aceleración fuerte
 * @author Omar.beltran
 */
public class EBStrongAceleration {
    ...
    public double getAceleracionVehiculo() {
        return aceleracionVehiculo;
    }

    public void setAceleracionVehiculo(double aceleracionVehiculo) {
