package com.grupomovil.entity.geo.alarms;

import org.bson.types.ObjectId;

/**
 * Entidad que permite manejar la alarma del estado del cinturón de seguridad
 * @author Omar.beltran
 */
public class EBSeatBeltStatus {
    ...
    String codigoAlarma;
    String nivelAlarma;
    boolean estadoCinturonSeguridad;
    ...
    public boolean isEstadoCinturonSeguridad() {
        return estadoCinturonSeguridad;
    }

    public void setEstadoCinturonSeguridad(boolean estadoCinturonSeguridad) {
